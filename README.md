# 2022 Fall "Biostats and Big Data 2" at SKKU GBME
...
------| ------ | ----- | -------- | --- | ---
**Week 1** |
8/29  |  | (**R**ecording) Softwares and programming languages |  | 
8/31  |  | (**O**ffline) Class overview and computer tests |  | |
**Week 2** | | | |
9/5 | | (**O**) JAMOVI-Getting started  |  | |
9/7 | | (**R**) Target research articles and datasets  | | |
**Week 3** | | | |
9/12 | | 추석 | | | |
9/14 | | (**R**) Wrangling data | | | |
**Week 4** | | | |
9/19 | | (**O**) Wrangling data hands-on  | | |
9/21 | | (**R**) Data Exploration | | | |
**Week 5** | | | |
9/26 | | (**O**) Data Exploration hands-on | | |
9/28 | | 공부자탄강일  | | |
**Week 6** | | | |
...
**Week 9** | | | |
10/24 | | (**R**) ANOVA in JAMOVI |  |  | HW2, due: 11/4|
10/26 | | (**O**) ANOVA hands-on |  | |
**Week 10** | | | |
